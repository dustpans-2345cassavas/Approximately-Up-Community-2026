...
# 🎮 Approximately Up — Community Edition

**A physics-driven climb where every meter counts.**
...
Approximately Up is a physics-based vertical platformer in which players climb a tall, shifting tower using precise movement, momentum, and careful timing. Every ascent tests patience and control, with progress measured in height gained and falls survived. This Community Edition is a standalone build of the complete game, delivered as a self-contained package. It is ready to play immediately and requires no additional software.

This build is for players who want the complete single-player climb of Approximately Up in an independent, offline release for Windows.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3904850/6411599641f2ce41d52afa013c41e3f4bc5e2e4b/ss_6411599641f2ce41d52afa013c41e3f4bc5e2e4b.1920x1080.jpg?t=1788255956" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3904850/5105fb84a92559483a21d205f1023474a3950fcd/ss_5105fb84a92559483a21d205f1023474a3950fcd.1920x1080.jpg?t=1788255956" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3904850/8d98fc09927caf6b916bdbf2b38772740b18d9ea/ss_8d98fc09927caf6b916bdbf2b38772740b18d9ea.1920x1080.jpg?t=1788255956" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🧗 **Physics-Based Climbing** — Momentum-driven movement system where balance and precision decide success.
- 🗼 **Vertical Ascent** — A single continuous climb where the goal is simple: get as high as possible.
- 🎯 **Precision Controls** — Tight, responsive input handling built for deliberate, skillful play.
- ⏱️ **Built-In Timer** — Track ascent time and personal bests across attempts.
- 🎨 **Minimalist Art Direction** — Clean visual design that keeps focus on movement and height.
- 🔊 **Ambient Audio** — Layered environmental sound that shifts as the climb progresses.
- 🎮 **Full Controller Support** — Play with keyboard or gamepad, both fully configurable.
- 💾 **Progress Tracking** — Session statistics and best-height records stored locally.
- 📦 **Self-Contained Package** — All game files included in one independent release, no storefront required.
- 🚀 **Ready to Play Immediately** — Install and launch directly, offline and without additional setup.

- **Compression:** Lossless
- **Install Time:** ~2 minutes on SSD, ~5 on HDD
- **Recoding:** none
- **Selective Download:** Not applicable — complete self-contained package
...
| **RAM** | 4 GB | 8 GB |
| **Graphics** | NVIDIA GeForce GTX 750 Ti / AMD Radeon R7 260X (2 GB VRAM) | NVIDIA GeForce GTX 1050 Ti / AMD Radeon RX 560 (4 GB VRAM) |
| **Storage** | 3 GB available space | 3 GB available space on SSD |
| **Additional** | DirectX 11 compatible sound card | DirectX 11 compatible sound card, keyboard or gamepad |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\ApproximatelyUp\Saved`
